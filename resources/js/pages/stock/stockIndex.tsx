          ...
          {currentProducts.length > 0 ? (
            currentProducts.map((item) => (
              ...
              >
                ...
                {/* Stock y acciones */}
                <div className="mt-auto pt-3 border-t border-amber-100 flex flex-col gap-2">
                  <span
                  ...
                  <div className="flex gap-2 justify-between">
                    <button
                      ...
                      className="px-4 py-2 bg-[#E17100] hover:bg-amber-700 text-white text-sm font-medium rounded-lg flex items-center gap-1"
                    >
