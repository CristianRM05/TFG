                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    {user ? (
                        <section className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            <Card title="📦 Productos" link="/products" description="Gestiona todos los productos en stock." />
                            <Card title="🏷️ Estanterías" link="/shelves" description="Ubicación y estado de cada estantería." />
